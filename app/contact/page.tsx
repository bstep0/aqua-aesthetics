    ...
    <div className="container mx-auto py-16 px-4 md:px-8">
      ...
      <div className="mb-16 text-center">
        <h1 className="mb-4 text-4xl font-extrabold text-gray-900 sm:text-5xl">
          Contact Aqua Aesthetics Pools
        </h1>
        <p className="mx-auto max-w-3xl text-lg text-gray-600 leading-relaxed">
          Ready to make a splash? Whether you're building a new pool, remodeling an existing one, or need regular maintenance, our team is here to help. Contact us today for a consultation or free estimate — we make the process simple and stress-free!
        </p>
      </div>
      ...
      <div className="grid gap-10 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-gray-200 bg-white shadow-md p-8 flex flex-col items-center text-center hover:shadow-lg transition-shadow duration-300">
          ...
          <p className="mb-4 text-gray-600 max-w-sm">
            Our team is ready to answer your questions and schedule your pool service. Quick, friendly, and professional.
          </p>
      ...
      <div className="mt-16 text-center max-w-3xl mx-auto">
        ...
        <ul className="grid gap-6 sm:grid-cols-2 list-disc list-inside text-gray-600 text-lg text-left pl-6 leading-relaxed">
